...
window.TileBuilders = {
	...
	kinerja: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "kinerja",
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB-INF/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB-INF/images/app-kinerja.png',
            //appUrl: 'gaji/index.php'
			appUrl: "javascript:top.document.location.href='../skp/index.php'"
        };
    },
	
	tugasbelajar: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "tugasbelajar",
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB-INF/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB-INF/images/app-tugasbelajar.png',
            //appUrl: 'gaji/index.php'
			appUrl: "javascript:top.document.location.href='../tugasbelajar/index.php'"
        };
    },
